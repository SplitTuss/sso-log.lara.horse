...
import { UserSearchIcon, Trash2Icon, PencilIcon } from 'lucide-react';
...
export const EditHorse = ({ horseId }: EditHorseProps) => {
    ...
    <div>
      ...
      >
        <DialogTrigger asChild>
          <button className="hover:cursor-pointer text-muted-foreground">
            <PencilIcon />
          </button>
        </DialogTrigger>
