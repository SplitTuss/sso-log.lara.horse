      ...
      <div className="m-4">
        ...
        <div className="flex flex-col items-center text-xl">
          <p>
            ...
            <Link href="/horseLog" className="flex justify-center underline">
              see my log
            </Link>
          </p>
          <p>
            If you are new here and wondering what this page is, how to use it and why someone would
            have created it, here`s some explanations:
          </p>
        </div>

        <div className="flex flex-col text-center">
          <div className="font-bold text-xl text-primary">what is this?</div>
          <div>
            This website was made to keep track of all the horses each StarStableOnline Account
            owns. I combined the data from the SSO-DB site and the in-game data to make it more
            visually interesting and easier to use with certain filters.
          </div>
          <div className="font-bold text-xl text-primary">why?</div>
          <div>
            To make life easier. I`ve always been keeping track of my sso horses and accounts in a
            paper book but they keep adding breeds, coats and new generations of breeds and at some
            point the paper book was so annoying that I decided to learn coding and fix this problem
            once and for all.
          </div>
          <br />
          <div className="font-bold text-xl text-primary">how do I use it?</div>
          <div className="font-bold">adding horses and accounts:</div>
          <ul>
            <li>
              ...
              corner. If you have multiple accounts, you could hide the owned horses and their
              adjacent names.
            </li>
            <li>
            ...
            <li>
              ...
              sure it is saved or if you wanted to move it to a different browser or machine.
            </li>
          </ul>
          <br />
          ...
          <div className="mb-6">
            <p>
              ...
              my account. So I created a paperback book, in which i glued the printed out photos
              that i got from the SSO-DB.
            </p>
            <p>
            ...
            <p>
              The second most importatnt reason was that I wanted to learn coding and I saw a
              problem that needed a solution and took it into my own hands to find this solution, by
